...
SL1 <- owner_durs %>% filter(Owner == sd_staff$Owner[1])
SL2 <- owner_durs %>% filter(Owner == sd_staff$Owner[2])
SL3 <- owner_durs %>% filter(Owner == sd_staff$Owner[3])
SL4 <- owner_durs %>% filter(Owner == sd_staff$Owner[4])
SL5 <- owner_durs %>% filter(Owner == sd_staff$Owner[5])
SL6 <- owner_durs %>% filter(Owner == sd_staff$Owner[6])
SL7 <- owner_durs %>% filter(Owner == sd_staff$Owner[7])
...
cat(">>>", sd_staff$Owner[1], "Total tickets:", nrow(SL1), "\n")

if(nrow(SL1) == 0) {
     cat("No current tickets for", sd_staff$Owner[1])
} else {
     knitr::kable(SL1) %>%
...
cat(">>>", sd_staff$Owner[2], "Total tickets:", nrow(SL2), "\n")

if(nrow(SL2) == 0) {
     cat("No current tickets for", sd_staff$Owner[2])
} else {
     knitr::kable(SL2) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
...
cat(">>>", sd_staff$Owner[3], "Total tickets:", nrow(SL3), "\n")

if(nrow(SL3) == 0) {
     cat("No current tickets for", sd_staff$Owner[3])
} else {
     knitr::kable(SL3) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
...
cat(">>>", sd_staff$Owner[4], "Total tickets:", nrow(SL4), "\n")

if(nrow(SL4) == 0) {
     cat("No current tickets for", sd_staff$Owner[4])
} else {
     knitr::kable(SL4) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
...
cat(">>>", sd_staff$Owner[5], "Total tickets:", nrow(SL5), "\n")

if(nrow(SL5) == 0) {
     cat("No current tickets for", sd_staff$Owner[5])
} else {
     knitr::kable(SL5) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
...
cat(">>>", sd_staff$Owner[6], "Total tickets:", nrow(SL6), "\n")

if(nrow(SL6) == 0) {
     cat("No current tickets for", sd_staff$Owner[6])
} else {
     knitr::kable(SL6) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
...
cat(">>>", sd_staff$Owner[7], "Total tickets:", nrow(SL7), "\n")

if(nrow(SL7) == 0) {
     cat("No current tickets for", sd_staff$Owner[7])
} else {
     knitr::kable(SL7) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
...
===========================================================================  
**Group 3: Total Tickets Aged up to 30 Days: `r nrow(days_30)` (`r round((nrow(days_30) / nrow(dat) * 100), digits = 2)` % of total)**   **Non-Service Desk Tickets: `r nrow(nsd_days_30)`**  
===========================================================================  
...
===========================================================================  
**Group 4: Total Tickets Aged 1 Week or Less: `r nrow(days_07)` (`r round((nrow(days_07) / nrow(dat) * 100), digits = 2)` % of total)**   **Non-Service Desk Tickets: `r nrow(nsd_days_07)`**  
===========================================================================  
